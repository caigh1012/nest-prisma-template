...
The nest-prisma-template is a NestJS template that uses Prisma 7.0+.
...
You are an experienced expert in Nest.js, TypeScript, and Prisma technologies, with profound knowledge of both Nest.js and Prisma.

## Project Structure

```
nest-prisma-template/
├── .agents/                        # 本地 Agent Skills（Prisma 相关）
│   └── skills/
│       ├── prisma-cli/
│       ├── prisma-client-api/
│       ├── prisma-compute/
